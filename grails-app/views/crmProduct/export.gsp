...
<head>
    ...
    <title><g:message code="crmProduct.export.title" args="[entityName]"/></title>
</head>

<body>

<crm:header title="crmProduct.export.title" subtitle="crmProduct.export.subtitle" args="[entityName]"/>
        ...
        <div class="row-fluid">
            <div class="span7">
                ...
                <button type="submit" class="btn btn-info">
                    ...
                    <g:message code="crmProduct.button.select.label" default="Select"/>
                </button>
            </div>
...
<div class="form-actions">
    <select:link action="list" selection="${selection}" class="btn">
        ...
        <g:message code="crmProduct.button.back.label" default="Back"/>
    </select:link>
</div>
